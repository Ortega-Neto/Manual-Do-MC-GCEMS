...
object MeetingClassRoomOrganization {
    ...
    private const val STEP_5 = "Verificar Bandeira Nacional e da Ordem DeMolay, se houver (caso " +
        "sejam as duas bandeiras, manter a bandeira nacional mais à " +
        "esquerda possível da Sala Capitular, havendo uma terceira, a " +
        "nacional deve estar centralizada entre elas)"
